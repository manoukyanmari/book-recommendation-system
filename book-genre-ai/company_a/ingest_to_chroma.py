...
def run_ingestion():
    ...
    df = pd.read_csv("company_a/company_a_genres_output.csv")
    ...
    Chroma.from_documents(
        ...
        persist_directory="company_a/chroma_db"
    )
    print("Chroma DB successfully created at company_a/chroma_db directory.")
