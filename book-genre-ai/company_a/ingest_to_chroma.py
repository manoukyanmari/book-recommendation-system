...
# Navigate up one level from 'company_a' to find the '.env' file in 'book-genre-ai'
...
def run_ingestion():
    csv_file_path = os.path.join(current_file_directory, "company_a_genres_output.csv")
