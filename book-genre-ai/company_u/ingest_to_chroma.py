...
def run_ingestion():
    ...
    df = pd.read_csv("company_u/company_u_genres_output.csv")
    ...
    Chroma.from_documents(
        ...
        persist_directory="company_u/chroma_db"
    )
    print("Chroma DB successfully created at company_u/chroma_db directory.")
